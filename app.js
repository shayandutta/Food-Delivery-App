  ...
  return (
    <div className="restaurant-card">
      <img
        ...
        src="https://dineout-media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/v1662123565/g9jkqizsya3gakm6mkcw.webp"
      />
      <h4>{resName}</h4>
      <h5>{cuisine}</h5>
      <h5>{rating}</h5>
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">
        <RestaurantCard resName="Meghna Foods" cuisine="pizza , biryani, asian" rating="4.4 stars" time="38 minutes"/>
        <RestaurantCard />
        <RestaurantCard />
        <RestaurantCard />
        <RestaurantCard />
